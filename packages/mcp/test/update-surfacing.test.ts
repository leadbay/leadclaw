...
const LATEST = "0.20.0";
const DXT_URL =
  "https://github.com/leadbay/mcp/releases/download/mcp-v0.20.0/leadbay-mcp-0.20.0.dxt";
const MCPB_URL =
  "https://github.com/leadbay/mcp/releases/download/mcp-v0.20.0/leadbay-mcp-0.20.0.mcpb";
  ...
  it("does not attach anything when no update is cached", async () => {
    ...
    await store.write({
      ...
      latest_known_install_url:
        "https://github.com/leadbay/mcp/releases/download/mcp-v0.19.2/leadbay-mcp-0.19.2.dxt",
